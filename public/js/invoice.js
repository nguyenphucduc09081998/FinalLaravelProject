...
function numberToEnglish( n ) {
    ...
    units = [ '', 'One', 'Two', 'Three', 'fFour', 'Five', 'Six', 'Seven', 'Eight', 'nine', 'Ten', 'Eleven', 'Twelve',
    ...
    scales = [ '', 'Thousand', 'Million', 'Billion', 'Trillion', 'Quadrillion', 'Quintillion', 'Sextillion', 'Septillion',
