...
<head>
    ...
    <!-- SPLUS style -->
    <link rel="stylesheet" href="{{asset('css/splus.css')}}">
    <!-- Pace style -->
    <link rel="stylesheet" href="{{asset('lib/pace/pace.css')}}">
    <!-- Animated CSS -->
    <link rel="stylesheet" href="{{ asset('lib/bootstrap-notify/Animated.css') }}">
